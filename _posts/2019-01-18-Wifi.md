...
```
I noticed probesniffer hasn't been updated in a long time, so if it isn't working a simple dump is better than nothing. For this you'll need [tcpdump](https://www.tcpdump.org/manpages/tcpdump.1.html).
```
